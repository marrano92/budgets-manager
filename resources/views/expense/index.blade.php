            ...
            @if( $expenses->count() > 0)
                ...
                @foreach($expenses as $expense)
                    <tr class="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
                        ...
                        <td class="border-grey-light border hover:bg-gray-100 p-3 truncate"> {{ $expense->state}} </td>
                        <td class="border-grey-light border hover:bg-gray-100 p-3 truncate"> {{$expense->value}} €</td>
