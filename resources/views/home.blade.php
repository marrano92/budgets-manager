            ...
            <div class="bg-white border rounded shadow p-2">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        <h5 class="font-bold uppercase text-gray-500">{{__('Total expenses')}}</h5>
                        <h3 class="font-bold text-3xl">{{$obj->total}} € <span class="text-green-500"><i
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-3">
            ...
            <div class="bg-white border rounded shadow p-2">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        <h5 class="font-bold uppercase text-gray-500">{{__('Total Events')}}</h5>
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-3">
            ...
            <div class="bg-white border rounded shadow p-2">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        <h5 class="font-bold uppercase text-gray-500">{{__('Total courses')}}</h5>
